...
<style type="text/css">
#divBG {
background-image:url('http://pics.recipe4living.com/squeeze/Copycat-Top-Secret-MaleChef.png');
...
<div id="divBG">
	...
	<div id="emailRow">
		<input style="background-color: #fdee8f;" type="text" id="email" name="email" value="<?php echo $email; ?>" size="25" maxlength="100" onfocus="if(this.value=='Your Email')this.value=''" onblur="if(this.value=='')this.value='Your Email'"><br><br>
		<INPUT style="vertical-align:bottom;" TYPE="image" SRC="http://pics.recipe4living.com/squeeze/subscribe1.png" BORDER="0" ALT="Submit Form" />
	</div>
</div>
</form>
<?php
