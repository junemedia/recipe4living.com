...
<style type="text/css">
#divBG {
background-image:url('http://pics.recipe4living.com/squeeze/DIABETIC-RECIPES.png');
...
<div id="divBG">
	...
	<div id="emailRow">
		<input style="background-color: #fdee8f;" type="text" name="email" value="<?php echo $email; ?>" size="25" maxlength="100"><br>
		<INPUT style="padding-top:10px;vertical-align:bottom;" TYPE="image" SRC="http://pics.recipe4living.com/squeeze/subscribe1.png" BORDER="0" ALT="Submit Form" />
	</div>
</div>
</form>
<?php
