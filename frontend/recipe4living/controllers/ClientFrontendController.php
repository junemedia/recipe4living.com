...
abstract class ClientFrontendController extends FrontendController
{
	...
	public function __construct($args)
	{
		...
		//}
		/////////////////////////////
		/*can be swiched on if want to show multiple level herarichy. *\
		/*if(Request::getString('recipeslug')){ 
			$recipesslug = end(explode('/',Request::getString('recipeslug')));
		}else if(Request::getString('controller') == 'recipes'){
			$recipesslug = Request::getString('controller');
		}
		else{
			$recipesslug = 'recipes';
		}*/
		
		/*if(Request::getString('articleslug')){ can be swiched on if want to show multiple level herarichy and do same with articles.
			$articleslug = end(explode('/',Request::getString('articleslug')));
		}else if(Request::getString('controller') == 'articles'){
			$articleslug = Request::getString('controller');
		}
		else{
		...
		// currently it will always find no results and so in template hard code categories will work. use full when above code un commented
		$articleslug = 'articles';
		$articlelinks = ''; 
		//$articlelinks = $this->_getLandingLinks($articleslug);
...
//		$links['/recipes/shopping_list'] = 'My Shopping List';
...
//		$links['/account/blog_posts'] = 'My Blog Posts';
	...
	protected function _getLayout()
	{
		...
		if (!isset($layout)) {
			if (ISBOT) {
				...
				$default = 'grid';//BluApplication::getSetting('defaultItemsView', 'grid');
