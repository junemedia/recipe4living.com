	...
	<?php /* ?>
						<dt><label for="form_location">Location <span class="red-ast">*</span></label></dt>
						<dd>
							<input name="form_location" class="textinput" type="text" id="form_location" size="30" maxlength="100" value="<?= $location ?>" />
							<small class="fieldhint">Please enter your city / state / country in this field. Please make sure to select your location from the list before moving on to the next field.</small>
