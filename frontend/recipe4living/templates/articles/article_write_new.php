						...
						<div id="categories_accordion" class="fieldwrap categories">
							...
							<div class="block">
								...
								<ul>
									<?php foreach ($parent['values'] as $category) {
										...
										{
									?>
										<li><label class="check"><input type="checkbox" name="categories[main_ingredients][<?= $category['slug']; ?>]" value="<?= $category['id']; ?>"<?= isset($selectedCategories[$parent['slug']][$category['slug']]) || isset($selectedCategories['main_ingredients'][$category['slug']]) ? ' checked="checked"' : ''; ?> /> <?= $category['name']; ?></label></li>
									<?php }
									} ?>
								</ul>
								<div class="clear"></div>
							...
							<!--<div class="block">
								...
								<ul>
									...
									<li><label class="check"><input type="checkbox" name="categories[a_dash_of_fun][<?= $category['slug']; ?>]" value="<?= $category['id']; ?>"<?= isset($selectedCategories['a_dash_of_fun'][$category['slug']]) ? ' checked="checked"' : ''; ?> /> <?= $category['name']; ?></label></li>
									<?php } ?>
								</ul>
								<div class="clear"></div>
							</div>
							...
							<div class="block">
								...
								<ul>
									...
									<li><label class="check"><input type="checkbox" name="categories[hints_tips][<?= $category['slug']; ?>]" value="<?= $category['id']; ?>"<?= isset($selectedCategories['hints_tips'][$category['slug']]) ? ' checked="checked"' : ''; ?> /> <?= $category['name']; ?></label></li>
									<?php } ?>
								</ul>
								<div class="clear"></div>
							</div>
							...
							<div class="block">
								...
								<ul>
									...
									<li><label class="check"><input type="checkbox" name="categories[thinking_healthy][<?= $category['slug']; ?>]" value="<?= $category['id']; ?>"<?= isset($selectedCategories['thinking_healthy'][$category['slug']]) ? ' checked="checked"' : ''; ?> /> <?= $category['name']; ?></label></li>
									<?php } ?>
								</ul>
								<div class="clear"></div>
							</div>-->
