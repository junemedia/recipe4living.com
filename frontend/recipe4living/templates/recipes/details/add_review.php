<!--
	<div id="comment" class="screenonly">
		...
		<form id="form-review-recipe" method="post" action=""><div>
			<textarea name="comments" id="q" cols="10" rows="4" class="simpletext" title="Write your review here"></textarea>

			<button type="submit" class="button-md fl"><span>Submit your review</span></button>
...
<?php if ($this->_doc->getFormat() != 'print') { ?>
    <!--<div id="disqus_thread" class="screenonly"></div>
