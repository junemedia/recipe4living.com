			...
			<div id="panel-center" class="column">
				...
				<div id="post">
					...
					<div class="im fl screenonly fieldwrap image" style="width: 200px; height: 200px;">
						<?php if(!empty($image)) { ?>
						<img src="<?= ASSETURL . '/tempimages/200/200/3/' . $image ?>" alt="<?= $default_alt;?>" />
						<?php } else { ?>
						<img src="<?= ASSETURL; ?>/itemimages/200/200/3/<?= isset($item['image']) ? $item['image']['filename'] : ''; ?>" alt="<?= $default_alt;?>" />
						<?php } ?>
					</div>
					...
					<div class="entry">
						...
						<?php include(BLUPATH_TEMPLATES.'/recipes/details/body.php'); ?>
					...
					<form id="form_article_save" name="form_article_save" action="<?= SITEURL . (isset($submitUrl) ? $submitUrl : '/share') ?>" method="post">
						...
						<div class="fieldwrap">
							<button name="save" class="button-lg fl" type="submit" value="save"><span>Save your recipe</span></button>
						</div>
					</form>
